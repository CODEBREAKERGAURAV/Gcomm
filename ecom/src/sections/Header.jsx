...
const Header = () => {
  ...
  return (
    ...
    <div className="w-full px-16 py-2 bg-yellow-400 lg:flex hidden justify-between items-center gap-6">
      ...
      <h1 className="text-sm font-semibold flex justify-center items-center gap-2"><MdEmail className="size-[18px]"/><span>Gaurav@gmail.com</span></h1>
    </div>
    <nav className="w-full bg-gray-100 flex justify-between items-center gap-1 lg:px-16 px-6 py-5 sticky top-0 z-50">
      <h1 className="text-purple-500 font-bold lg:text-[30px] text-3xl underline italic ">Gaurav-comm</h1>
