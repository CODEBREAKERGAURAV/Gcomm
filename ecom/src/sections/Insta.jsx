...
const Insta = () => {
  ...
  return (
    <div className="w-full lg:px-20 px-5 py-[80px] bg-white flex flex-col justify-center items-center gap-4">
      <h1 data-aos="zoom-in" data-aos-delay="100" className="text-purple-500 text-xl font-semibold capitalize">Our Instagram Shop</h1>
     ...
     <button data-aos="zoom-in" data-aos-delay="300"  className="bg-purple-500 hover:bg-yellow-400 text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-12 uppercase">#er_grv_2910</button>
    </div>
  )
}
